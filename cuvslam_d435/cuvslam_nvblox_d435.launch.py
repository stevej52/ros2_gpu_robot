...
def generate_launch_description():
    ...
    # No colour (nothing here uses it; it costs USB bandwidth and a core), no
    # alignment, no sync: the splitter pairs frames by their own metadata.
    ...
    # where base_footprint started) to the top of the chassis, and there is no
    # colour stream.
